...
This plugin provides OpenAPI-spec and SwaggerUI for SCM-Manager.

## Usage

Find out how this plugin can be used on the [user documentation page](https://scm-manager.org/plugins/scm-openapi-plugin/docs).
